...
_SYSTEM = (
    ...
    "help.faq_safety|help.faq_who_for|help.faq_childcare|help.faq_zip_privacy; "
    ...
    "PRODUCT FAQ (all four: goal=chat, in_discovery=false, confidence high — a direct question "
    "outranks any funnel step, even mid-flow): "
    "help.faq_safety = trust/vetting questions about whether people here are real or safe "
    "('how do I know the moms on here are real and not creeps?', 'are profiles verified?'). "
    "help.faq_who_for = who-is-this-app-for questions from dads, caregivers, grandparents, or "
    "expecting moms ('I'm a stay at home dad with a 3 year old, is this app for me too?', "
    "'I'm pregnant with my first, due in october. too early for this app?', 'is this only for moms?'). "
    "help.faq_childcare = ONLY when asking whether Lana/TagAlng PROVIDES childcare or babysitting "
    "('do you offer babysitting?', 'can you watch my kids?') — a sitter/daycare RECOMMENDATION ask "
    "('know a good babysitter?') stays looking.tip. "
    "help.faq_zip_privacy = ZIP/location privacy concerns ('I'd rather not give my zip code, is that "
    "ok?', 'why do you need my zip?', 'who sees my zip?') — NOT settings.change_zip (that's updating it). "
