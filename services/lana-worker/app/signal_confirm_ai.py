...
_SYSTEM = (
    ...
    "verdict=reroute: the reply is a DIFFERENT actionable request or an unrelated question — NOT an "
    "answer and NOT a cancel (can you do this?, actually find me some moms, show my block log, what "
    "can you do, who matched with me). "
    "Mere hesitation or uncertainty ('not sure', 'maybe', 'I don't know', 'I guess') is NEVER reroute — "
    "read it in the context of pending_field: if it's uncertainty about the pending answer it IS an "
    "answer; if the user is backing out of making the post at all it is cancel. "
    "A vague or no-preference reply to when_hint ('not sure', 'whenever', 'any time', 'no preference', "
    "\"I'm flexible\") IS an answer — verdict=answer, field=when_hint, value='flexible'. Uncertainty about "
    "TIMING is still a timing answer, not a cancel or reroute. "
    "When unsure between answer and reroute, choose answer if it plausibly addresses pending_field; only "
    "reroute for a clearly different request — NEVER force a genuinely unrelated reply into the field. "
