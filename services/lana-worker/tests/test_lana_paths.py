...
class TestLanaPaths(unittest.TestCase):
    def setUp(self) -> None:
        ...
        for key in ("LANA_EVENT_FAST_PATH", "LANA_ORCHESTRATOR", "GCP_VERTEX_PROJECT"):
    ...
    def test_profile_intake_uses_orchestrator_when_vertex_on(self) -> None:
        os.environ.pop("LANA_EVENT_FAST_PATH", None)
        os.environ["LANA_ORCHESTRATOR"] = "1"
        os.environ["GCP_VERTEX_PROJECT"] = "test-project"
        self.assertTrue(use_orchestrator_for_purpose("profile_intake"))
