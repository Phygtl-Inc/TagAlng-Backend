...
class TestLocalizedFunnelTurns(unittest.TestCase):
    ...
    def test_activities_message_localized_but_titles_as_authored(self) -> None:
        ...
        self.assertIn("FIFA watch party", msg)  # event titles never translated
